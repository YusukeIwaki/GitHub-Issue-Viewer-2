...
public class GitHubLoginFragment extends AbstractLoginFragment {
  ...
  @Override protected void onCreateView(@Nullable Bundle savedInstanceState) {
  ...
  private void launchBrowser() {
    String callbackUrl = new Uri.Builder().scheme(getString(R.string.github_oauth_callback_scheme))
